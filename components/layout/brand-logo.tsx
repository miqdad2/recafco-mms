...
export function BrandLogo({ variant = "dark", size = "sm", showText = true }: BrandLogoProps) {
    ...
    <div className="flex items-center gap-3">
      ...
      {showText ? (
        <div>
          ...
          <p className={cn("text-sm", variant === "dark" ? "text-gray-300" : "text-[#4B5563]")}>Enterprise Maintenance Management</p>
        </div>
      ) : null}
    </div>
  );
