...
export type PermissionKey =
  ...
  | "work_orders.update"
  | "work_orders.close"
  | "work_orders.inventory_check"
  | "work_orders.review"
  | "work_orders.request_correction"
  ...
  | "parts_requests.edit"
  | "parts_requests.issue"
  | "parts_requests.mark_waiting_stock"
  | "store.issue"
  | "store.receive"
  | "offline_inventory.view"
  | "offline_inventory.issue"
  | "offline_inventory.ledger"
  | "inventory.movements.view"
  | "purchase_requests.view"
  | "purchase_requests.manage"
  | "purchase_orders.view"
  | "purchase_orders.manage"
  | "purchase.production_approve"
  | "purchase.factory_approve"
